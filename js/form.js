...
const talleresMartes9am = "<option value='' default>Elige el taller</option><option value='TallerintroductoriodeUnrealAndrésChinchilla-AulaN01'>Taller introductorio de Unreal Andrés Chinchilla - Aula N01</option><option value='AsísomoslosticosyasípodemossermejoresGeovannyDebrusJiménez-AulaN09'>Así somos los ticos y así podemos ser mejores  Geovanny 'Debrus' Jiménez - Aula N09</option>";
...
const talleresMartes11am = "<option value='' default>Elige el taller</option><option value='EsencialCostaRica,EconomíaNaranjaKevinVillalta-AulaN03'>Esencial Costa Rica, Economía NaranjaKevin Villalta - Aula N03 </option><option value='Torneo:HookbotsporTreeInteractive'>Torneo: Hookbots por Tree Interactive</option>";
